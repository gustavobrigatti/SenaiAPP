...
<?php
    ...
    $_iContador = 0;              
    $_sql = "SET GLOBAL sql_mode=(SELECT REPLACE(@@sql_mode,'ONLY_FULL_GROUP_BY',''))";
    $_query = mysqli_query( $_conexao , $_sql ) or die ( mysqli_error( $_conexao ) );                        
    $_sql = "SELECT * FROM mensagem WHERE id_de = '$_id_usuario' GROUP BY texto ORDER BY id_mensagem desc";
