...
<?php
    ...
    $_query = mysqli_query( $_conexao , $_sql ) or die ( mysqli_error( $_conexao ) );
        ...
        { 
            ...
            $_excluido_permanente = $_line['excluida_permanente'];
...
?>                      
    ...
    <?php
      if($_notificacao == 1){  
    ?>
    <script src="../js/pages/ui/notifications_excluido_permanente.js"></script>
    <?php
