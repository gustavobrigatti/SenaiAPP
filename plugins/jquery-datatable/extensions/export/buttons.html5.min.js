...
"Tabela copiada"),b.i18n("buttons.copySuccess",{1:"Linha copiada com suceso",_:"%d linhas copiadas."},a.rows),2E3);return}}catch(h){}}e=g("<span>"+b.i18n("buttons.copyKeys","Pressione <i>ctrl</i> ou <i>⌘</i> + <i>C</i> para copiar a tabela<br>.<br><br>To cancel, click this message or press escape.")+"</span>").append(d);b.buttons.info(b.i18n("buttons.copyTitle","Tabela copiada."),e,0);c[0].focus();c[0].select();var l=g(e).closest(".dt-button-info"),i=function(){l.off("click.buttons-copy");
